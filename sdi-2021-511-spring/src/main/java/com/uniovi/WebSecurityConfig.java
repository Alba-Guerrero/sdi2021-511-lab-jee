	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests()
		 .antMatchers("/css/**", "/img/**", "/script/**", "/", "/signup","/login/**").permitAll()
				 ...
				 .antMatchers("/profesor/add").hasAnyAuthority("ROLE_ADMIN")
				 .antMatchers("/profesor/edit/*").hasAnyAuthority("ROLE_ADMIN")
				 .antMatchers("/profesor/delete/*").hasAnyAuthority("ROLE_ADMIN")
